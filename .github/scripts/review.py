...
class CodeReviewer:
    ...
    def analyze_code(self, code: str, file_path: str, gemini_token: str) -> str:
        ...
        Provide a detailed code review for this Flutter code and a short description for the PR and a changelog.
        Focus on:
    ...
    def create_pr_comment(self, reviews: List[Dict[str, Any]]):
        ...
        """
        comment_body = "## :robot_face: AI Code Review\n\n"
        ...
        for comment in existing_comments:
            if ":robot_face: AI Code Review" in comment.body:
